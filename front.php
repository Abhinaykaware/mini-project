<?php  include('db_connect_db_new.php');
   ...
   $resultToday = mysqli_num_rows(mysqli_query($link,$sql));   
   $resultS = mysqli_query($link,$sqlOnline);        
...
<input class = "form-control" name= "rid" type = "number"  placeholder="" required/>
...
<h3 style="padding-left:10px;text-align:center;">Visitor Management System</h3>
